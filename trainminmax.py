...
fitness=AgainstMinmaxFitness(10, 2)
...
def run(config_file):
    ...
    files = [f for f in os.listdir('.') if "neat-minmax-checkpoint-" in f]
    ...
    if len(generations)!=0:
        ...
        stdout.flush()
        p = neat.Checkpointer.restore_checkpoint('neat-minmax-checkpoint-'+str(most))
    else:
    ...
    p.add_reporter(neat.Checkpointer(1, filename_prefix='neat-minmax-checkpoint-'))
